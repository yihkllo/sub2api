export default {
  ...
  home: {
    ...
    liveRelay: 'Cloud relay service online',
    // User-focused value proposition
    heroSubtitle: 'One Key, All AI Models',
    heroDescription: 'Unified API keys, account pool routing, usage details, and quota controls in one dashboard for Claude Code, Codex, Gemini CLI, and more.',
    tags: {
  ...
  setup: {
    title: '云笺 Setup',
    description: 'Configure your 云笺 instance',
    database: {
  ...
  admin: {
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for 云笺 end-user login',
      ...
      site: {
        ...
        siteSubtitlePlaceholder: '稳定的 AI 中转服务',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to 云笺',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the 云笺 AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
